...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Link.additional_params'
        db.add_column(u'djangocms_link_link', 'additional_params',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Link.additional_params'
        db.delete_column(u'djangocms_link_link', 'additional_params')
